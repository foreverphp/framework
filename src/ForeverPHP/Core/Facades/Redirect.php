...
/**
 * @method static \ForeverPHP\Http\RedirectResponse to(string $path, int $status = 301, array $headers = [])
 * @method static \ForeverPHP\Http\RedirectResponse route(string $name)
 * @method static void error(int $errno)
 * @method static \ForeverPHP\Http\RedirectResponse makeRedirect(string $path, int $status = 301, array $headers = [])
 *
