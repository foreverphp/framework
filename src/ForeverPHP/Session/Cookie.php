...
class Cookie
{
     ...
     * @param bool $secure      Indica que la cookie sólo debiera transmitirse por una conexión segura HTTPS
     *                          desde el cliente.
     * @param bool $httponly Cuando es TRUE la cookie será accesible sólo a través del protocolo HTTP.
     */
     ...
     * @param string  $path     La ruta dentro del servidor en la que la cookie estará disponible.
     * @param string  $domain   El dominio para el cual la cookie está disponible.
     * @param bool $secure      Indica que la cookie sólo debiera transmitirse por una conexión
     *                          segura HTTPS desde el cliente.
     * @param bool $httponly Cuando es TRUE la cookie será accesible sólo a través del protocolo HTTP.
     */
    ...
    /*public static function set_array($name, $array, $expire = 0, $path = null,
